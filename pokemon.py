...
class Pokemon:
    def __init__(self, name, types, moves, EVs, health='==================='):
        ...
        self.health = health
        self.bars = 100  # Amount of health bars
    ...
    def fight(self, Pokemon2):
        ...
        damage_multiplier = 1.5  # You can adjust this value
        ...
        while (self.bars > 0) and (Pokemon2.bars > 0):
            ...
            # Determine damage
            Pokemon2.bars -= damage_multiplier * self.attack
            Pokemon2.health = ""
            ...
            # Determine damage
            self.bars -= damage_multiplier * Pokemon2.attack
            self.health = ""
...
if __name__ == '__main__':
    ...
    Charmeleon.fight(Ivysaur)  # Get them to fight